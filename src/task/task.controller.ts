...
export class TaskController {
  ...
  @ApiResponse({ status: 200, description: 'Return tasks for the project', type: [TaskResponseDto] })
  async findByProjectId(@Param('projectId') projectId: string): Promise<TaskResponseDto[]> {
